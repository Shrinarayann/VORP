...
def solve_cvrp(data):
    ...
    def distance_callback(from_index, to_index):
        ...
        # Make sure to convert to int if the distance matrix contains floats
    ...
    search_parameters.time_limit.FromSeconds(data.get("time_limit", 5))  # Increased time limit
    ...
    try:
        ...
        print(f"Error in solve_cvrp: {str(e)}")
